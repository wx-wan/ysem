  ...
  try {
    ...
    const order = await prisma.order.create({
      data: {
        ...
        sampleAmountCNY: sampleAmountCNY ? Number(sampleAmountCNY) : null,
        moldFeeCNY: moldFeeCNY ? Number(moldFeeCNY) : null,
        moldFeeRefundable: moldFeeRefundable || false,
        deliveryDate,
        paymentTerms,
  ...
  try {
    ...
    const order = await prisma.order.update({
      ...
      data: {
        ...
        orderType: orderType !== undefined ? orderType : existing.orderType,
        amountCNY: amountCNY !== undefined ? Number(amountCNY) : existing.amountCNY,
        sampleAmountCNY: sampleAmountCNY !== undefined ? Number(sampleAmountCNY) : existing.sampleAmountCNY,
        moldFeeCNY: moldFeeCNY !== undefined ? Number(moldFeeCNY) : existing.moldFeeCNY,
        moldFeeRefundable: moldFeeRefundable !== undefined ? moldFeeRefundable : existing.moldFeeRefundable,
